...
from train_hamilton_ppo import instrument_arrival_fill, PHI, ALPHA, DT, ACTION_BOUND_TOL
...
def run_eval_episode_full(model, seed: int, inventory_scale: float,
    ...
    """
    import compare_four_policies_paired as C4P  # READ ONLY; local import avoids a hard dependency
