"""
shared/compare_four_policies_paired.py
---------------------------------
...
Run:
    python shared/compare_four_policies_paired.py --episodes 20 --verify-episodes 20
    python shared/compare_four_policies_paired.py --episodes 1000 --verify-episodes 20 --output results/four_policy_paired_1000.csv
"""
...
import shared.simulate_belief_weighted as SBW  # existing policy definitions -- READ ONLY
