"""
shared/evaluate_agents_event_driven.py
----------------------------------
...
Run from repo root:
    python shared/evaluate_agents_event_driven.py --run-tag event_diag --training-seed 0
"""
...
import shared.evaluate_agents_common as EAC  # READ ONLY (schema, build_row, aggregation)
from shared.train_agents import RECURRENT_AGENT_TYPES, RunningStats  # READ ONLY
