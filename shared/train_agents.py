...
Run from repo root:
    python shared/train_agents.py --agent-type hamilton_ppo    --total-timesteps 20000 --seed 0
    python shared/train_agents.py --agent-type return_mlp_ppo   --total-timesteps 20000 --seed 0
    python shared/train_agents.py --agent-type return_lstm_ppo  --total-timesteps 20000 --seed 0
"""
...
def main():
    ...
    print("=" * 78)
    print(f"shared/train_agents.py [{args.agent_type} / {args.run_tag}] -- structural-validation run "
