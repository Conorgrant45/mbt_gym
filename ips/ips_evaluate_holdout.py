...
Run from repo root:
    python ips/ips_evaluate_holdout.py                       # both calibrations, whatever checkpoints exist
    python ips/ips_evaluate_holdout.py --calibrations original
    python ips/ips_evaluate_holdout.py --calibrations high_penalty
"""
import sys as _sys
