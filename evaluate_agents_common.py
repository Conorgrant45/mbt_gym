...
Run from repo root:
    python evaluate_agents_common.py --run-tag diag --training-seed 0
"""
...
import hamilton_ppo_eval_lib as HEL  # READ ONLY (run_eval_episode_full reused unchanged)
from train_hamilton_ppo import PHI, ALPHA, DT, ACTION_BOUND_TOL  # READ ONLY
